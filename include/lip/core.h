 ...
 * @see lip_print_error
 */
LIP_CORE_API const lip_context_error_t*
 ...
 */
LIP_CORE_API lip_module_context_t*
 ...
 */
LIP_CORE_API lip_exec_status_t
 ...
 * @see lip_native_fn_t
 */
LIP_CORE_API const lip_value_t*
